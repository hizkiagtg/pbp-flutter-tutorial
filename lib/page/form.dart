                            ...
                            child: Container(
                              child: ListView(
                                ...
                                children: <Widget>[
                                  ...
                                  Center(
                                      child: const Text(
                                          'Berhasil menyimpan data sebagai berikut:')),
                                  Text('Nama lengkap Anda adalah ' +
                                      _namaLengkap),
                                  if (jenjangSarjana)
                                    Text(
                                        'Jenjang pendidikan Anda adalah Sarjana')
                                  else if (jenjangDiploma)
                                    Text(
                                        'Jenjang pendidikan Anda adalah Diploma')
                                  else if (jenjangMagister)
                                    Text(
                                        'Jenjang pendidikan Anda adalahMagister')
                                  else if (jenjangDoktor)
                                    Text(
                                        'Jenjang pendidikan Anda adalah Doktor')
                                  else
                                    Text('Jenjang tidak Valid, harap diisi'),
                                  Text(
                                      'Kelas PBP yang Anda ikuti adalah kelas ' +
                                          kelasPBP),
                                  Text('Usia Anda adalah ' +
                                      umur.toString() +
                                      'tahun'),
                                  if (_nilaiSwitch)
                                    Text('Anda sedang dalam mode berlatih')
                                  else
                                    Text(
                                        'Anda tidak sedang dalam mode berlatih'),
                                  TextButton(
                                    onPressed: () {
